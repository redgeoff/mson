...
export class Compiler {
  ...
  _getWrappedComponentClass(name, defaultProps, parentProps, className) {
    ...
    class MyComponent extends Component {
      ...
      // off with keep-classnames, but instead we’ll just use a custom className so that we don’t
  ...
  _instantiate(props) {
    ...
    each(props, (prop, name) => {
      if (typeof prop === 'object' && prop !== null) {
        // Prevent prototype pollution: https://github.com/redgeoff/mson/security/code-scanning/2
